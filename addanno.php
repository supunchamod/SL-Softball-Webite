           ...
           $contact=$_POST['contact'];
            if($_FILES["image"]["error"] == 4){
                ...
                if ( !in_array($imageExtension, $validImageExtension) ){
                  ...
                  $sql="INSERT INTO anno(name,contact,image)VALUES( '$name' , '$contact','$newImageName')";
     ...
     <div class="col-lg-5 pt-5">
                    <div class="card border-0">
                        <div class="card-header bg-primary text-center p-4">
                            <h1 class="text-white m-0">Add Announcer</h1>
                        </div>
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form method="post" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control p-4" placeholder="Add Announcer" required="required" />
                                </div>
                                <div class="form-group">
